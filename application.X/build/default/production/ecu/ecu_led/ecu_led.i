...
# 11 "ecu/ecu_led/../../mcal/mcal_gpio/mcal_gpio.h" 2

# 1 "ecu/ecu_led/../../mcal/mcal_gpio/../../std_types.h" 1
# 11 "ecu/ecu_led/../../mcal/mcal_gpio/../../std_types.h"
...
# 30 "ecu/ecu_led/../../mcal/mcal_gpio/../../std_types.h"
typedef enum {
    R_NOK,
    R_OK
} ret_status;
# 12 "ecu/ecu_led/../../mcal/mcal_gpio/mcal_gpio.h" 2
...
ret_status led_initialize(led_t *led) {
    ...
    if ((((void*)0) == led) || (led->port_info.port_name > 5UL - 1) ||
            (led->port_info.pin > 8UL - 1)) {
        return ret;
    } else {
