...
# 2 "<built-in>" 2
# 1 "mcal/mcal_gpio/mcal_gpio.c" 2
...
# 8 "mcal/mcal_gpio/mcal_gpio.c" 2


# 1 "mcal/mcal_gpio/mcal_gpio.h" 1
# 11 "mcal/mcal_gpio/mcal_gpio.h"
...
# 11 "mcal/mcal_gpio/mcal_gpio.h" 2

# 1 "mcal/mcal_gpio/../../std_types.h" 1
# 11 "mcal/mcal_gpio/../../std_types.h"
...
# 30 "mcal/mcal_gpio/../../std_types.h"
typedef enum {
    R_NOK,
    R_OK
} ret_status;
# 12 "mcal/mcal_gpio/mcal_gpio.h" 2
...
# 10 "mcal/mcal_gpio/mcal_gpio.c" 2
...
ret_status gpio_port_get_direction_status(port_index port, direction_t *direction) {
    ret_status ret = R_NOK;
    if (port > 5UL - 1 || ((void*)0) == direction) {
        return ret;
    } else {
